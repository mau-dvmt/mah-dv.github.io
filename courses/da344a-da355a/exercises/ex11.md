...
# Laboration 11 - Metodik

Välkommen till lab 11! Idag ska vi leka lite med git, npm, Webpack och testverktyget Jest. Dessutom, som en bonus, ska du få använda dig av ett terminalfönster! Wohoo!

![YASSS!](https://media0.giphy.com/media/ZUOlQXqO0qbAI/giphy.gif?cid=790b76115cd33fd16f34486d413aa16a&rid=giphy.gif)
...
Om du instalelrade Homebrew ovan, kan du nu använda samma metod för att installear Node.js. Öppna terminalen och skriv:
...
![Johans terminalfönster](11/terminal.png)
...
Det här ser lite annorlunda ut, beorende på vilket operativsystem du kör, vilket språk du har vaölt och vilken version av ditt operativsystem du kör. På macOS kommer det till exempel troligtvis att stå `/User/dittnamn`, medan det på Windows troligtvis kommer att stå `c/Users/dittnamn` eller något liknande.
...
Asterisken (_*_) är ett *wildcard* och betyder *matcha alla strängar*. Således kommer _*txt_ att matcha alla filer som slutar på *txt*.
...
![En ny katalog](11/new-directory.png)
...
Vi har nu en fil som finns i vår *arbetskopia* (se [föreläsning 11](../lectures/le11)), men som ännu inte är versionshanterad. Detta kan vi se genom att köra kommandot `git status`:
...
![But whyyyy?](https://media.giphy.com/media/5z5SeDlfIwPhpHjmG5/giphy.gif)
...
![Mission accomplished](https://media3.giphy.com/media/Mp4hQy51LjY6A/giphy.gif?cid=790b76115cd36d4d5469442f4df964bf&rid=giphy.gif)
...
![Signup for GitHub](11/sign-up-github.png)
...
Gå tillbaka till din terminal och säkerställ att du står i din projektkatalog. Står du kvar i poesi-katalogen går du upp en nivå. Nu ska vi nämligen skapa ett nytt lokalt repository genom att klona vårt repository från GitHub. Börja med att kopiera webaddressen till ditt repository. Mitt, exempelvis, finns på [https://github.com/koddas/testing-with-jest](). Var noga med att använda ditt egna repository, och inte använda mitt. Nu klonar du ner ditt repository genom att skriva
...
![Johans incheckningsmeddelande](11/commit-message.png)

Nu har du en extra fil och en ny revision:

![En ny fil](11/with-readme.png)
...
![Det här är för Anton](https://media0.giphy.com/media/MOWPkhRAUbR7i/giphy.gif?cid=790b76115cd3a14f3662614359f5cfc1&rid=giphy.gif)
